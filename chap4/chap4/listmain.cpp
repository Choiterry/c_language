...
//	while (i != 0)
//	{
//		l.insert(i); //  여기서 하나저장하고
//		cin >> i; //여기서 만약 0이면 저장안하고 바로 탈출할 수 있게 함
//	}
//	
//	cout << "here is the element in the list" << "\n";
//	
//	listelementtype elem; //여기서 변수를 이렇게 설정해도 중요한건 객체인 l에 있으므로 elem은 상관없음
//	bool notempty(l.first(elem)); //만약 l.first(elem)이 true인자 false인지 나올거임 아니면 true이니까 
